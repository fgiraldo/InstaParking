...
class AdditionalsControllerTest < ActionController::TestCase
  ...
  test "should create additional" do
    assert_difference('Additional.count') do
      post :create, additional: { active: @additional.active, description: @additional.description, sypply_id: @additional.sypply_id }
    end
  ...
  test "should update additional" do
    patch :update, id: @additional, additional: { active: @additional.active, description: @additional.description, sypply_id: @additional.sypply_id }
    assert_redirected_to additional_path(assigns(:additional))
  end
